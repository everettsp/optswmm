...
for station_id in station_ids:
    ...
    oc = OptConfig(
        ...
        log_every_n = 1,
        algorithm = "Powell",
        algorithm_options={"maxiter":10, "xtol":0.05},
        score_function=["nse"],
        name="homoge-rel-1yr", # no underscores
    ...
    cps = CalParams()
    cps.append(CalParam(section='infiltration', attribute='CurveNum', lower=-0.9, upper=2, lower_limit=0, upper_limit=100, distributed=False, relative=True))
    cps.append(CalParam(section='subcatchments', attribute='PercImperv', lower=-0.9, upper=2, lower_limit=0, upper_limit=100, distributed=False, relative = True))
    ...
    cps.append(CalParam(section='subcatchments', attribute='Width', lower=-1, upper=4, lower_limit=0, upper_limit=10000000, distributed=False, relative=True))
    ...
    cps.append(CalParam(section='xsections', attribute='Geom2', lower=-0.9, upper=4, lower_limit=0.05, upper_limit=5, distributed=False, relative=True))
    cps.append(CalParam(section='inflows', attribute='Baseline', lower=-1, upper=4, lower_limit=0, upper_limit=10, distributed=False, relative=True))
